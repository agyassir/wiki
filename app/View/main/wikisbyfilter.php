        ...
        <div class="container">
            <div class="row">
                <div
                    ...
                    <h1 class="h2 mb-4">Showing items from <mark><?=$tag->type?></mark></h1>
                    <?php
                    foreach ($rs as $wiki):
                        ?>
                        <article class="card mb-4">
                            <div class="post-slider">
                                <img src="./assets/images/post/post-7.jpg" class="card-img-top" alt="post-thumb">
                            </div>
                            <div class="card-body">
                                ...
                                <ul class="card-meta list-inline">
                                    ...
                                    <li class="list-inline-item">
                                        <ul class="card-meta-tag list-inline">
                                            <li class="list-inline-item"><a href="#"><?=$rs->name?></a></li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <aside class="col-lg-4 sidebar-inner">
                    ...
                    <div class="widget">
                        ...
                        <article class="widget-card">
                            <div class="d-flex">
                                <img class="card-img-sm" src="../public/assets/images/post/post-7.jpg">
                                <div class="ml-3">
                                    <h5><a class="post-title" href="post-details.html">Advice From a Twenty Something</a></h5>
                                    <ul class="card-meta list-inline mb-0">
                                        <li class="list-inline-item mb-0">
